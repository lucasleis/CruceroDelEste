    ...
    <section className="relative flex items-start justify-center pt-20 pb-0 px-6 min-h-[700px] overflow-hidden md:py-20">
      ...
      <div className="relative z-20 max-w-7xl mx-auto w-full flex flex-col md:flex-row items-start md:items-center justify-between text-white px-2 md:px-6 gap-4 md:gap-0 pt-4 md:pt-0 pb-8 md:pb-0">
        <div className="max-w-2xl text-left">
          <div className="inline-block bg-[#e3000f] px-2 py-0.5 mb-4 md:mb-8 text-[10px] md:text-xs font-bold tracking-widest uppercase rounded-sm">
            SOBRE NOSOTROS
          </div>
          <h1 className="text-xl md:text-6xl font-bold mb-3 md:mb-6 leading-[1.1]">
            Excelencia en Movimiento a Través del Paraná
          </h1>
          <p className="text-xs md:text-xl mb-4 md:mb-10 leading-relaxed opacity-90">
          ...
          <div>
            <a
              className="inline-block bg-[#e3000f] text-white px-6 py-3 text-sm md:px-10 md:py-4 md:text-lg font-bold rounded-[4px] shadow-lg hover:bg-red-700 transform hover:-translate-y-1 transition-all duration-200"
              href="#"
            >
              Comprar Pasajes
            </a>
